...
export class InterceptorService implements HttpInterceptor {
	constructor(private auth: AuthService, private toastrService: ToastrService, private loadingService: NgxSpinnerService) {}
	...
	intercept(request: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
		...
		return next.handle(request != null ? requestToken : request).pipe(
			tap(
				(event: HttpEvent<any>) => {
